...
export class StudentProfileResponseDto {
  ...
  @ApiProperty({
    description: 'Target IELTS score the student aims to achieve',
    example: 7.5,
    minimum: 0,
    maximum: 9,
  })
...
export class TeacherProfileResponseDto {
  ...
  @ApiProperty({
    description: 'Educational degree of the teacher',
    example: 'Bachelor of Arts in English Literature',
  })
  degree: string;

  @ApiProperty({
    description: 'Specialization areas (comma-separated)',
    example: 'LISTENING,READING,WRITING,SPEAKING',
  })
  ...
  @ApiProperty({
    ...
    example:
      'Experienced IELTS instructor with 5+ years of teaching experience.',
  })
  bio: string;
